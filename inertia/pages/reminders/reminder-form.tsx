...
// Local schema to avoid type conflicts
const localReminderSchema = z.object({
  title: z.string().min(1, 'Title is required').max(255, 'Title must be less than 255 characters'),
  description: z.string().optional(),
  reminderDateTime: z.string().min(1, 'Reminder date and time is required'),
  isEmailNotification: z.boolean(),
  isBrowserNotification: z.boolean()
})

type LocalReminderFormData = z.infer<typeof localReminderSchema>
...
export default function ReminderForm({
  ...
  const form = useForm<LocalReminderFormData>({
    resolver: zodResolver(localReminderSchema),
    defaultValues: {
      title: '',
      description: '',
      reminderDateTime: '',
  ...
  const onSubmit = async (data: LocalReminderFormData) => {
    setProcessing(true)
